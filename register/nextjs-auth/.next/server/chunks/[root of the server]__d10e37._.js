...
async function POST(request) {
    ...
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM users WHERE email = ?', [
            email
        ]);
        if (rows.length === 0) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])().set('user', JSON.stringify({
            id: user.id,
            email: user.email
        }), {
            maxAge: 60 * 60 * 24
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d10e37._.js.map